...
#
# Single image serving BOTH transports of the vgi-etf-vanguard worker:
...
ARG SOURCE_URL=https://github.com/Query-farm/vgi-etf-vanguard

LABEL org.opencontainers.image.title="vgi-etf-vanguard" \
      org.opencontainers.image.description="Vanguard US ETF data as a VGI worker for DuckDB/SQL (stdio + HTTP)" \
